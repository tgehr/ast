...
string[] keywords = ["dat","def","true","false","if","then","else","observe","assert","return","repeat","for","while","in","cobserve","import","Π","Pi","as","coerce","pun","forget"]~(language==psi?["pure"]:[])~(language==silq?["λ","lambda","quantum","const","lifted","qfree","mfree","classical"]:[]);
